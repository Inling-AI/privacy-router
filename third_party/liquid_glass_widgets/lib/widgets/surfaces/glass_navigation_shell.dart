...
class GlassNavigationShell extends StatefulWidget {
  ...
  /// Position chrome within a pane without clipping its shadows to that pane.
  /// The shell and its overlay still occupy the entire window.
            ...
            Overlay.wrap(
              child: ListenableBuilder(
                ...
                builder: (context, _) {
                  ...
                  return GlassNavPinnedHost(
                    state: state,
                    chromeInsets: widget.chromeInsets,
                  );
                },
              ),
            ),
