...
class GlassNavPinnedHost extends StatelessWidget {
  ...
  const GlassNavPinnedHost({
    super.key,
    required this.state,
    this.chromeInsets = EdgeInsets.zero,
  });

  /// Layout guides only; the parent overlay remains window-sized.
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
      top: topPad + chromeInsets.top,
      left: GlassNavPinnedMetrics.horizontalPadding + chromeInsets.left,
      right: GlassNavPinnedMetrics.horizontalPadding + chromeInsets.right,
